...
const Navbar = () => {
  ...
  return (
    <nav className="flex justify-between w-fixed w-full flex-shrink flex-grow-0 px-4 items-center py-2 bg-sky-800">
      ...
      <div>
        {
          ...
          !loginCheck ? (
            ...
            <button className="bg-orange-300 hover:bg-red-700 text-white font-bold py-2 px-4 rounded" type='button'>
              <Link to='/login'>Login</Link>
            </button>
          ) : (
            // Render logout button if user is logged in
            <button className="bg-orange-300 hover:bg-red-700 text-white font-bold py-2 px-4 rounded" type='button' onClick={() => {
